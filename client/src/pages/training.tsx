...
import { Search, Filter, SlidersHorizontal, X, GraduationCap } from "lucide-react";
...
const trainingCategories = [
  "technology", "business", "languages", "design", "marketing", 
  "healthcare", "education", "management", "finance", "other"
];
...
export default function Training() {
  ...
  const { data: trainings = [], isLoading } = useQuery<Opportunity[]>({
    queryKey: ['/api/opportunities', { type: 'training', province: selectedProvince !== 'all' ? selectedProvince : undefined, search: searchQuery || undefined, status: 'approved' }],
  });
  ...
  const FilterContent = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-2">
          {trainingCategories.slice(0, 5).map((category) => (
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold" data-testid="text-page-title">{t("training")}</h1>
        </div>
